...
const firstLetters = (strs) => {
  // Solution code here...
  return strs.map((word) => word.charAt(0));
};
...
const findAnything = (strs, target) => {
  // Solution code here...
  return strs.filter((word) => word.includes(target));
};
...
const allAnything = (strs, target) => {
  // Solution code here...
  return strs.every((word) => word.includes(target));
};
...
const unenrollBrook = (roster) => {
  // Solution code here...
  return roster.map((personList) => personList.filter((person) => !person.includes('Brook')));
};
